...
def extract_geography(
    ...
    # City
    #
    # The city is normally the nearest meaningful
    # address component immediately before the state.
    # Skip locality/directional fragments and postal
    # codes.
    # ---------------------------------------------
...
class BuilderDiscoveryService:
    ...
    # ---------------------------------------------
    # Strong builder evidence always qualifies.
    # ---------------------------------------------
    ...
    if strong_matches:
        ...
        candidate.qualification_reasons.append(
            ...
            f"found: {', '.join(strong_matches)}."
        )

        if supporting_matches:
            candidate.qualification_reasons.append(
                "Supporting development evidence "
                f"found: {', '.join(supporting_matches)}."
            )

        return True

    # ---------------------------------------------
    # Generic construction/development evidence
    # alone is not enough.
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # Explicit non-builder classification.
    # ---------------------------------------------
