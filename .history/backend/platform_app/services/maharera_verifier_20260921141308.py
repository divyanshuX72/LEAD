...
class MahaRERAVerifier:
    ...
    This service never rejects a lead.
    It only adds verification evidence.
    """
    ...
    async def _search_promoter(
        ...
        source_url = PROMOTER_SEARCH_URL
