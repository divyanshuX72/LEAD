...
class WebsiteProjectResearcher:
    ...
    This is deliberately different from the generic
    ContactScraper.

    ContactScraper extracts contact information.

    This service extracts commercial/project activity
    evidence useful for ATREAL ranking.
    """
    ...
    def _build_research(
        ...
        for url, html in pages:
            ...
            if not signals and not self._is_project_candidate(
                url
            ):
                continue
